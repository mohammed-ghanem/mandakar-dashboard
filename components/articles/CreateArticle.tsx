...
import { useCreateArticleMutation } from "@/store/articles/articlesApi";
...
export default function CreateArticle() {
  ...
  const t = translate?.pages.articles?.createArticle;
