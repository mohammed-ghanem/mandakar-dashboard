...
import { useCreateLectureMutation } from "@/store/lectures/lecturesApi";
...
export default function CreateLecture() {
  ...
  const t = translate?.pages.lectures?.createLecture;
