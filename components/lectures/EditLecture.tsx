...
import { ILectureLink } from "@/types/lectures";
...
export default function EditLecture() {
  ...
  const t = translate?.pages.lectures?.editLecture;
  ...
  const [updateLecture, { isLoading: isUpdating }] =
    useUpdateLectureMutation();
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      content_ar: lecture.content?.ar ?? "",
      content_en: lecture.content?.en ?? "",
      category_id:
        lecture.category_id != null ? String(lecture.category_id) : "",
      ...
      links:
        lecture.links && lecture.links.length > 0
          ? lecture.links
          : [{ title: "", url: "" }],
      seo_description: lecture.seo?.description ?? "",
      seo_keywords: (lecture.seo?.keywords ?? []).join(", "),
    });
        ...
        <CardContent className={dash.formCardContent}>
          <form onSubmit={submit} className="space-y-8 md:space-y-10">
            ...
            <section className={dash.sectionNeutral}>
              ...
              <ImageDropzone
                file={form.image}
                existingImageUrl={lecture.image || undefined}
            ...
            <section className={dash.sectionRichContent}>
              ...
              <CkEditor
                key={`lecture-edit-ar-${lecture.id}`}
            ...
            <section className={dash.sectionRichContent}>
              ...
              <CkEditor
                key={`lecture-edit-en-${lecture.id}`}
            ...
            <section className={dash.sectionNeutral}>
              ...
              <AudioDropzone
                file={form.audio}
                existingAudioUrl={lecture.audio || undefined}
